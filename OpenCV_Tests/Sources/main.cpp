...
#include "../Headers/Videos.h"
//#include "../Headers/Tracking.h" // Errors : external symbol unsolved --> Error LNK2001 ; I don't know how to solve this shit, nothing worked. Maybe due to the fact the tracker is not a stable (opencv_contrib)
#include "../Headers/DetectPeopleHOG.h"
...
int main() {
    ...
    //res = detectPeopleUsingHistogramOfOrientedGradients();
